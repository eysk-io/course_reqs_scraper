...
void update_each_course(TidyBuffer* tidy_buffer, int* num_courses, mongoc_client_t *client, mongoc_collection_t *collection);

void update_courses(CourseSubjectScraper course_subject_scraper, int* num_courses, mongoc_client_t *client, mongoc_collection_t *collection);
